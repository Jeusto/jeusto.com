...
Card.Image = function CardImage({ src, alt, ...props }) {
  return (
    <div className="relative z-10 aspect-square h-60 w-full overflow-hidden rounded-2xl bg-zinc-100 group-hover:opacity-75 sm:h-72">
      <img
        src={src}
        alt={alt}
...
Card.Cta = function CardCta({ children }) {
  return (
    ...
    >
      {children}
      <FiChevronRight className="ml-1 stroke-current" />
    </div>
  )
}
